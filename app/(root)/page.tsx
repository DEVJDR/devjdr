  ...
  return (
    <ClientPageWrapper>
      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-2 text-center -mt-20">
          <Image
            src={profileImg}
            height={100}
            width={100}
            ...
            alt="Arun - Full Stack Developer Portfolio"
            priority
          />
          <AnimatedText
            as="h1"
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                ...
                aria-label="View DEVJDR GitHub profile"
              >
            ...
            <AnimatedText delay={0.8}>
              <Link
                href={"https://drive.google.com/file/d/17u6qC_r5Mm81Htu3RKkl82MnuSy0bS44/view"}
                rel="noreferrer"
                className={cn(
                  buttonVariants({
                    variant: "outline",
